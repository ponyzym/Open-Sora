...
# torchrun --standalone --nproc_per_node 4 scripts/inference.py configs/opensora/inference/16x512x512.py --ckpt-path pretrained_models/opensora/OpenSora-v1-HQ-16x512x512.pth --prompt-path ./assets/texts/t2v_samples.txt
# Auto Download
torchrun --standalone --nproc_per_node 1 scripts/inference.py configs/opensora/inference/16x512x512.py --ckpt-path pretrained_models/opensora/OpenSora-v1-HQ-16x512x512.pth --prompt-path ./ad_samples/t2v/test_samples.txt
